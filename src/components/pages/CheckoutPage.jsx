...
// Calculate order totals
    const calculateTotals = async () => {
      try {
        const totals = await orderService.calculateTotals(cartItems, shippingMethod.type)
    ...
    calculateTotals()
  }, [cartItems, shippingMethod, navigate])
                ...
                <div className="space-y-3">
                  ...
                  <div 
                    ...
                    onClick={() => setShippingMethod({
                      ...
                      name: 'Standard Delivery',
                      days: '5-7 business days',
                      price: orderTotals?.subtotal >= 100 ? 0 : 9.99
                    })}
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">
                          {orderTotals?.subtotal >= 100 ? (
                            ...
                            <Price amount={9.99} size="sm" showDiscount={false} />
                          )}
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">
                          <Price amount={19.99} size="sm" showDiscount={false} />
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">
                          <Price amount={29.99} size="sm" showDiscount={false} />
                        </p>
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-accent/10 text-accent ml-2">
